...
public class RestControllerExceptionHandler {
	...
	public ExceptionResponse handleUserException(UserException ex,WebRequest req) {
		log.error("UserException occured = {}",ex.getMessage());
	...
	@ResponseStatus(value=HttpStatus.BAD_REQUEST)
	public ExceptionResponse handleTrainerException(TrainerException ex,WebRequest req) {
		log.error("TrainerException occured = {}",ex.getMessage());
		return new ExceptionResponse(new Date().toString(),HttpStatus.BAD_REQUEST.name(),ex.getMessage(),req.getDescription(false));
	}
	
	@ExceptionHandler(TrainingTypeException.class)
	@ResponseStatus(value=HttpStatus.BAD_REQUEST)
	public ExceptionResponse handleTrainingTypeException(TrainingTypeException ex,WebRequest req) {
		log.error("TrainingTypeException occured = {}",ex.getMessage());
		return new ExceptionResponse(new Date().toString(),HttpStatus.BAD_REQUEST.name(),ex.getMessage(),req.getDescription(false));
	}
